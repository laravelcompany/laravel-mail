...
@section('content')
    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <form action="{{ route('laravel-mail.campaigns.cancel', $campaign->id) }}" method="post">
                @csrf
                <a href="{{ route('laravel-mail.campaigns.index') }}" class="btn btn-md btn-light">{{ __('Go Back') }}</a>
