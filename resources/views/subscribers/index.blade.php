...
@section('content')
    ...
    @component('laravel-mail::layouts.partials.actions')
        ...
        @slot('left')
            <form action="{{ route('laravel-mail.subscribers.index') }}" method="GET" class="form-inline mb-3 mb-md-0">
        ...
        @slot('right')
            ...
            <a class="btn btn-light btn-md mr-2" href="{{ route('laravel-mail.tags.index') }}">
            ...
            <a class="btn btn-success btn-md btn-flat" href="{{ route('laravel-mail.subscribers.import-new') }}">
                <i class="fa fa-file mr-1"></i> {{ __('Csv Import') }}
            </a>
        @endslot
    @endcomponent
            ...
            <table class="table table-dark">
                ...
                @forelse($subscribers as $subscriber)
                    <tr>
                        ...
                        <td>
                            <form action="{{ route('laravel-mail.subscribers.destroy', $subscriber->id) }}" method="POST">
                                @csrf
                                @method('DELETE')
